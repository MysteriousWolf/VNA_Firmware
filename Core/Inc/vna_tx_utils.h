...
size_t appendCharArray(char* destination, int destinationSize, const char* source);
size_t intToCharArray(int value, char *buffer, int bufferSize, bool terminate);

size_t send_data_to_queue(TX_QUEUE *char_queue, const char *data, size_t len);
